import requests, time, csv, os, simplejson, json
...
def fludia_call_api(source_file_name):
    ...
    try:
        r = requests.get('https://app.wattspirit.com/api/smk/p1m/1611820861/1621535641', headers={'Content-Type': 'application/json'},
